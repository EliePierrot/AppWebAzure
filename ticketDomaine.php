...
$requeteBloquant = "SELECT * FROM ticket  WHERE severite=1 AND domaine='$domaine'";
...
$requeteProblematique = "SELECT * FROM ticket  WHERE severite=2 AND domaine='$domaine'";
...
$requeteNonBloquant = "SELECT * FROM ticket  WHERE severite=3 AND domaine='$domaine'";
